...
/**
 * Precompiled gr.kmandalas.services.java-conventions script plugin.
 **/
public class GrKmandalasServicesJavaConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_GrKmandalasServicesJavaConventions").asSubclass(BasicScript.class);
